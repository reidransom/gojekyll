...
| `_data` | Well-formatted site data should be placed here. Jigyll autoloads `.yml`, `.yaml`, `.json`, and `.csv` files in this directory (subfolders are [namespaced by folder name](/docs/datafiles/)), accessible via `site.data`. |
